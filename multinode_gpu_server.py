...
# set default model
DEFAULT_MODEL = "llama-2-7b-chat-4-workers"
if len(model_names) > 0:
...
if __name__ == '__main__':
    ...
    # If torch.distributed initialized and rank=0, launch Flask server.
    # The POST method should broadcast de received payload.
    if dist.is_initialized():
        ...
        logger.error('Error: torch not initialized')